...
def main():
    ...
    parser.add_argument('--force', '-f', action='store_true', help='Forzar análisis de dominios excluidos')
    parser.add_argument('-o', '--output', choices=['txt', 'json', 'md'], default='txt', help='Formato de salida')
